												...
												<table id="example1"
													...
													<thead>
														<tr role="row">
															...
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1">Status Product</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1">Update Product</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1">Modify Product</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1">Description Product</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
													...
													<tbody>
														<c:forEach var="p" items="${listProducts}">
															<tr>
																...
																<td>${p.update_product}</td>
																<td>${p.modify_product}</td>
																<td>${p.description_product}</td>
																<td class="project-actions text-center"><a
																	class="btn btn-primary btn-sm"
																	href="${pageContext.request.contextPath}/admin/product/detail?id=${p.id_product}"><i
																		class="fas fa-folder"></i>View</a> <a
																	class="btn btn-info btn-sm"
																	href="${pageContext.request.contextPath}/admin/product/edit?id=${p.id_product}"><i
