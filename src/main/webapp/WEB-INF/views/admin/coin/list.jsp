					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Coin list</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">Coin list</h3>
								</div>
								<!-- /.card-header -->
								<div class="card-body">
										...
										<div class="row">
											...
											<div class="col-sm-12">
												<table id="example1"
													...
													<thead>
														<tr role="row">
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1">Id Coin</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1">Amount</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1">Update Coin</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1">Modify Coin</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
													...
													<tbody>
														<c:forEach var="coin" items="${listCoin}">
															<tr>
																<td>${coin.id_coin}</td>
																<td>${coin.amount}</td>
																<td>${coin.update_coin}</td>
																<td>${coin.modify_coin}</td>
																<td>${coin.user.id_user}</td>
																<td>${coin.user.username}</td>
																<c:choose>
																	<c:when test="${coin.status == 1}">												
																		<td>Active</td>
																	</c:when>
																	<c:otherwise>
																		<td>None Active</td>
																...
																<td class="project-actions text-center"><a
																	...
																	href="${pageContext.request.contextPath}/admin/coin/edit?id=${coin.id_coin}"><i
