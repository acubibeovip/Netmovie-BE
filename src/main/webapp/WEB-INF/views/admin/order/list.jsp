													...
													<thead>
														<tr role="row">
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1">Id Order</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1">Order Date</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1">Statusn</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1">Total Price</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1">Update Order</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1">Modify Order</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
													...
													<tbody>
														<c:forEach var="order" items="${orderList}">
															<tr>
																...
																<td>${order.update_order}</td>
																<td>${order.modify_order}</td>
																<td>${order.user.id_user}</td>
																<td>${order.user.username}</td>
																<td class="project-actions text-center"><a
																	class="btn btn-primary btn-sm"
																	href="${pageContext.request.contextPath}/admin/order/edit?id=${order.id_order}"><i
