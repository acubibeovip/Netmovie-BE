					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Actor list</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">Actor list</h3>
								</div>
								<!-- /.card-header -->
								<div class="card-body">
									<div id="example1_wrapper"
										...
										<div class="row">
											<div class="col-sm-3">
												<a
													href="${pageContext.servletContext.contextPath}/admin/actor/new"
													class="btn btn-success">Add actor</a>
											</div>
											<div class="col-sm-12">
												<table id="example1"
													...
													<thead>
														<tr role="row">
															...
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1">Name Actor</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1">Image Actor</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1">Country Actor</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1">Age Actor</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1">Follow Actor</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1">Update Actor</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1">Modify Actor</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
													...
													<tbody>
														<!-- SHOW DATA  -->
														<%
														List<ActorEntity> actorList = (List<ActorEntity>) request.getAttribute("listActor");
														%>
														<c:forEach var="actor" items="${listActor}">
															<tr>
																...
																<td>
																	<img src="${pageContext.request.contextPath}/img/${actor.image_actor}"
																		alt="" style="width: 150px; height: 150px">
																</td>
																<td>${actor.country_actor }</td>
																<td>${actor.age_actor }</td>
																<td>${actor.follow_actor }</td>
																<td>${actor.update_actor }</td>
																<td>${actor.modify_actor }</td>
