		...
		<div class="content-wrapper" style="min-height: 1342.88px;">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>Edit Storage Form</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a
									href="${pageContext.servletContext.contextPath}/admin">Home</a></li>
								<li class="breadcrumb-item active">Edit Storage Form</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Storage Form</h3>
								</div>
								<!-- /.card-header -->
								<!-- form start -->
								<form id="frmCategories"
									...
									<div class="card-body">
										<input type="hidden" id="id_storage"
											name="id_storage" value="${storageEdit.id_storage}">	
										<div class="form-group">
											<label for="name">Image Storage</label></br>
												<img src="${pageContext.request.contextPath}/img/${storageEdit.image_storage}"
													id="image_storage" name="image_storage" alt="" style="width: 150px; height: 150px"></br></br>
												<input type="file"
										...
										<div class="form-group">
											<label for="name">Video Storage</label></br>
												<video src="/admin/video/${storageEdit.video_storage}" width="150px" height="150px" controls preload="none"></video>
												</br></br>
												<input type="file"
