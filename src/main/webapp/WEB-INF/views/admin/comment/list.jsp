								...
								<div class="card-body">
									<div id="example1_wrapper"
										...
										<div class="row">
											<%-- <div class="col-sm-3">
												<a
													href="${pageContext.servletContext.contextPath}/admin/comment/new"
													...
													<thead>
														<tr role="row">
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1">Id Comment</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1">Comment</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1">Status Comment</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1">Update Comment</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1">Modify Comment</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1">Name User</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1">Id Rating</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
																rowspan="1" colspan="1">Name Film</th>
															<th class="sorting" tabindex="0" aria-controls="example1"
													...
													<tbody>
														<c:forEach var="comment" items="${listComments}">
															<tr>
																...
																<c:choose>
																	<c:when test="${comment.status_comment == 1}">												
																		<td>Active</td>
																	</c:when>
																	<c:otherwise>
																		<td>None Active</td>
																...
																<td>${comment.update_comment}</td>
																<td>${comment.modify_comment}</td>
																<td>${comment.user.username}</td>
																<td>${comment.id_ratting}</td>
																<td>${comment.film.title_film}</td>
																<td class="project-actions text-center"><a
																	class="btn btn-primary btn-sm"
																	href="${pageContext.request.contextPath}/admin/comment/detail?id=${comment.id_comment}"><i
																		class="fas fa-folder"></i>View</a> <a
																	class="btn btn-info btn-sm"
																	href="${pageContext.request.contextPath}/admin/comment/edit?id=${comment.id_comment}"><i
